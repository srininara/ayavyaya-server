...
class TestExpensesAPI(unittest.TestCase):
  ...
  def test_post_expenses_without_tags(self):
    payload = {'description':'test expense without tag', 'expense_date':'2014-07-31', 'amount':'110.10', 'category': 'Apparel', 'subcategory': 'Regular Wear', 'nature': 'Necessity', 'frequency': 'Regular' }
  ...
  def test_post_expenses_with_tags(self):
    payload = {'description':'test expense with tag', 'expense_date':'2014-06-29', 'amount':'110.10', 'tags': [{"name":"testTag1"},{"name":"testTag2"}], 'category': 'Apparel', 'subcategory': 'Regular Wear', 'nature': 'Necessity', 'frequency': 'Regular'}
    headers = {'content-type': 'application/json'}
